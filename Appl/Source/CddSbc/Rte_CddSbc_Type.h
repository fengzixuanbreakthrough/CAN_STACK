 ...
 *       License:  CBD1800257
 *
 *   Description:  Application types header file for SW-C <CddSbc> (Contract Phase)
 *********************************************************************************************************************/

/* double include prevention */
#ifndef _RTE_CDDSBC_TYPE_H
# define _RTE_CDDSBC_TYPE_H
